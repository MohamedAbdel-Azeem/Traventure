...
const Register: React.FC = () => {
  ...
  >
    <div className="bg-white rounded-lg shadow-2xl w-1/2 h-1/2 grid grid-cols-1 overflow-hidden backdrop-blur-md bg-opacity-70 p-8 m-4">
      <div className="flex flex-col justify-center items-center py-8 px-10 mt-2 mb-2 space-y-8">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-6 pb-8">
          ...
          <div className="text-center">
            ...
            <a href="/" className="text-purple-700 hover:text-purple-600 underline">
              Sign In
            </a>
          </div>
        </form>
