...
const {data, loading, error} = useGetAllProducts();
  ...
  const sortedProducts = (filteredProducts ?? []).sort((a, b) => {
    if (sortOrder) {
      return sortOrder === 'asc' ? calculateAverageRating(a) - calculateAverageRating(b) : calculateAverageRating(b) - calculateAverageRating(a);
    }
    return 0;
  });
  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <Box className="grid grid-cols-2">
            ...
            {type.includes("Admin")?
              ...
              onChange={(e) => {setExternalSeller(e.target.value)}}
            /></FormControl>
            :<></>}  
              <FormControl fullWidth className="col-span-2" sx={{ marginY: 1 }}>
      ...
      <div className="search-bar">
        ...
        />
            {!type.includes("Tourist")?<button className="submit-button3" onClick={handleOpen}>
