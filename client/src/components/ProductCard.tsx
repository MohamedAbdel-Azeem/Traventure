...
const ProductCard: React.FC<ProductCardProps> = ({ product, type }) => {
  ...
  const [editedProduct, setEditedProduct] =
    ...
    const {updateProduct, isLoading, didSucceed, error, updatedProduct} = useEditProduct(currentProduct, editedProduct, selectedImage);
  const togglePopup = () => {
          ...
          <div className="popup-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="popup-bottom">
              ...
              {type.includes("Tourist") ? (
                ...
                </button>:<button className="editBtn mr-[50px]">Loading...</button>}
