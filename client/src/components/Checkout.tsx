              ...
              <div className="flex flex-col w-[529.2px] h-[572px] gap-3">
                {saved_addresses?.map((address, index) => (
                  <button
                    ...
                    className="text-white text-[20px] border-white rounded-[7px] border-[1px] w-[500px] h-[77px] flex mx-auto"
                  >
                    {!address.floor ? (
                      <svg
                    ...
                    <div className="flex flex-col justify-between">
                      <div className="flex w-[423px] h-[35px] items-start flex-row justify-between">
                        <div>{!address.floor ? "House" : "Apartment"}</div>
                        <div>
                          {address.street} Building {address.buildingNumber}
                        </div>
                      </div>
                      <div className="flex break-words overflow-hidden items-end w-[420px] h-[35px] whitespace-nowrap text-ellipsis">
