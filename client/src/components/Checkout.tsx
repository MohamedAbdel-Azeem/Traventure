    ...
    <div className="flex flex-row mt-8">
      ...
      <div className="ml-10 h-[650px] w-[811px] bg-gradient-to-b from-[#A855F7] to-[#6D28D9] flex flex-col rounded-[10px] overflow-auto lasttimeipromise">
        ...
        <div className="flex flex-col mt-4">
          <div
            className="h-[84px] w-[788px] flex mx-auto"
            style={{
              backgroundImage:
                "url('https://uiverse.io/assets/banner2-BQVXx5-k.png')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          />
          <div className="flex flex-row mx-auto mt-3">
            <div className="w-[613px] h-[45px] text-white text-[32px]">
              Extremely Cheap Shoes
            </div>
            <div className="flex flex-row justify-between w-[161px] h-[45px]">
              <button
                onClick={() => {
                  if (count > 0) {
                    setCount(count - 1);
                ...
                title="Remove item"
                className="w-[45px] h-[45px] bg-[#ED2727] rounded-[8px] flex justify-center items-center"
              >
                <RemoveIcon />
              </button>
              <div className="w-[45px] h-[45px] bg-[#ACACAC] rounded-[8px] flex justify-center items-center text-[23px] text-white">
                {count}
              </div>
              <button
                onClick={() => setCount(count + 1)}
                title="Add item"
                className="w-[45px] h-[45px] bg-[#3E9A13] rounded-[8px] flex justify-center items-center"
              >
                <AddIcon />
              </button>
            </div>
          </div>
          <div className="w-[788px] h-[45px] text-white text-[32px] text-end mx-a">
            69.69
          </div>
        </div>
      </div>
