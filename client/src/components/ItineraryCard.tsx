  ...
  return (
    <div className="flex flex-col items-center justify-center mt-12">
      <div className="rounded-[19px]">
        <div
          className="w-[352px] h-[425px] bg-[#2a7306] rounded-[19px]"
          style={{
            background: `
        ...
        >
          ...
          <div className="text-[18px] h-[66px] text-center leading-[20px]">
            Are you tired of being robbed in First World Countries? Come try the
            same experience but in Egypt!
          </div>
          <div className="w-[352px] h-[60px] grid grid-cols-4 ">
            {activityCategories.map((text) => (
              <div
                className={`w-[82px] h-[22px] rounded-[34px] mx-auto my-auto text-[11px] flex flex-col items-center justify-center ${text.color}`}
              >
                {text.category}
              </div>
            ))}
          ...
          <div
            className="w-[352px] h-[46px] rounded-b-[19px] grid grid-cols-3"
            style={{
              background: `
          ...
          >
            <div className="border-dotted border-r-2 border-gray-400">
              <div className="flex flex-col items-start justify-start text-[13px] ml-2 mt-1">
                19/02/2025
              </div>
              <div className="flex flex-col items-end justify-end text-[13px] mr-2 mb-1">
                08/05/2026
              </div>
            </div>
